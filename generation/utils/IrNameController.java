...
public class IrNameController {
    ...
    public String getGlobalVarName() {
        return IrNameController.getPrefix(IrPrefix.GLOBAL_VAR_NAME) + globalVarNameIndex++;
    }
